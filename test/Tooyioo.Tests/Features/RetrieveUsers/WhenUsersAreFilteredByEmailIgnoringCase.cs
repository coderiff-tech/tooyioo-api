...
public sealed class WhenUsersAreFilteredByEmailIgnoringCase(MongoTestContainer mongoDb)
    : UserReadModelQueryTest(mongoDb)
{
    ...
    protected override async Task When()
    {
        ...
        _response = await Host.HttpClient.Get("/users?email=JANE.BLOGGS@TEST.COM", token);
    ...
    [Test]
    public async Task Then_response_contains_exact_email_match_regardless_of_case()
    {
