...
public sealed class WhenUsersAreFilteredByIdContainsIgnoringCase(MongoTestContainer mongoDb)
    : UserReadModelQueryTest(mongoDb)
{
    ...
    protected override async Task When()
    {
        ...
        _response = await Host.HttpClient.Get($"/users?id={_janeUserId.ToLowerInvariant()}", token);
    ...
    [Test]
    public async Task Then_response_contains_matching_user()
    {
